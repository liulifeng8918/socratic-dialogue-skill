...
description: Guide human-AI conversations with Socratic questioning. Use when the user explicitly asks for 苏格拉底式提问, 反问我, 帮我想清楚, Socratic questioning, guided reflection, assumption testing, challenge my assumptions, decision clarification, learning through questions, or help thinking something through. Trigger narrowly and implicitly only for reflective dialogue requests. Do not use for direct execution, coding, factual lookup, urgent answers, or finished deliverables unless the user asks to use reflective questioning.
---
